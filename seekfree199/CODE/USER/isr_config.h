...
#define CCU6_0_CH0_ISR_PRIORITY 31	//定义CCU6_0 PIT通道0中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样

#define CCU6_0_CH1_INT_SERVICE	0
#define CCU6_0_CH1_ISR_PRIORITY 30
...
#define ERU_DMA_INT_PRIO  	 254	//ERU触发DMA中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样
